...
func SetTitle() 
    ...
    if &filetype == 'sh' 
        ...
        call append(line(".")+1, "\# Author: wangyu190810") 

        call append(line(".")+2, "\# mail: wo190810401@gmail.com") 
	...
	elseif &filetype == 'python'
        ...
        call append(line(".")+2, "\#Author: wangyu190810") 

        call append(line(".")+3, "\#E-mail: wo190810401@gmail.com") 
